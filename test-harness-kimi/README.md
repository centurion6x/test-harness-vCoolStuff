...
Evaluates Kimi on 10 real TypeScript software engineering tasks by running it
...
```
Phase 1 (inside claude-kimi):  Kimi solves the tasks → writes results/solutions/*.ts
...
### Phase 1 — Solve (inside claude-kimi)
...
Claude Code (Kimi) will read all 10 task prompts and write solutions to
...
kimi-eval/
  ...
  results/
    solutions/               ← Kimi's solutions written here by Claude Code
      BUG_001.ts
      BUG_002.ts
      ...
  ...
  scripts/
    solve_tasks.py           ← Run inside claude-kimi to print tasks
