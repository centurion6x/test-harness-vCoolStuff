...
grade.py
--------
Run this OUTSIDE Claude Code, after Kimi has solved all tasks.
...
def main():
    parser = argparse.ArgumentParser(description="Grade Kimi solutions from Claude Code")
    ...
    out.write_text(json.dumps({"summary": summary, "model": "moonshotai/kimi-k2.5",
