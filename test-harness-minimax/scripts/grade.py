...
grade.py
--------
Run this OUTSIDE Claude Code, after minimax has solved all tasks.
...
def main():
    parser = argparse.ArgumentParser(description="Grade Minimax solutions from Claude Code")
    ...
    print(f"\n{'═'*60}")
    print(f"  MINIMAX EVAL — GRADE PHASE")
    ...
    out.write_text(json.dumps({"summary": summary, "model": "minimax/minimax-m2.5",
