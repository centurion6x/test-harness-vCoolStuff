...
grade.py
--------
Run this OUTSIDE Claude Code, after Opus has solved all tasks.
...
def main():
    parser = argparse.ArgumentParser(description="Grade Opus solutions from Claude Code")
    ...
    out.write_text(json.dumps({"summary": summary, "model": "anthropic/claude-opus-4-6",
