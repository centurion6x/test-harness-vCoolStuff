...
Evaluates the model on 10 real TypeScript software engineering tasks by running it
**inside Claude Code's agentic harness**, then grading the solutions with automated
Node.js tests and an optional Claude Opus judge.

## The two-phase workflow

```
Phase 1 (inside claude-<modelName>):  Model solves the tasks → writes results/solutions/*.ts
