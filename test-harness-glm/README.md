...
Evaluates GLM on 10 real TypeScript software engineering tasks by running it
...
```
Phase 1 (inside claude-glm):  GLM solves the tasks → writes results/solutions/*.ts
...
### Phase 1 — Solve (inside claude-glm)
...
Claude Code (GLM) will read all 10 task prompts and write solutions to
...
glm-eval/
  ...
  results/
    solutions/               ← GLM's solutions written here by Claude Code
      BUG_001.ts
      BUG_002.ts
      ...
  ...
  scripts/
    solve_tasks.py           ← Run inside claude-glm to print tasks
