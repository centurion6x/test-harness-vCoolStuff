...
grade.py
--------
Run this OUTSIDE Claude Code, after GLM has solved all tasks.
...
def main():
    parser = argparse.ArgumentParser(description="Grade GLM solutions from Claude Code")
    ...
    out.write_text(json.dumps({"summary": summary, "model": "z-ai/glm-5",
