# Qwencode Coding Eval

Evaluates Qwen Coder on 10 real TypeScript software engineering tasks by running it
...
```
Phase 1 (inside claude-qwencode):  Qwen Coder solves the tasks → writes results/solutions/*.ts
...
### Phase 1 — Solve (inside claude-qwencode)
...
Claude Code (Qwen Coder) will read all 10 task prompts and write solutions to
...
qwencode-eval/
  ...
  results/
    solutions/               ← Qwen Coder's solutions written here by Claude Code
      BUG_001.ts
      BUG_002.ts
      ...
  ...
  scripts/
    solve_tasks.py           ← Run inside claude-qwencode to print tasks
